                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" aria-label="Instagram da Podologia Sandra Barreto" className="text-gray-300 hover:text-white transition-colors">
                            ...
                            <a href="#" aria-label="Facebook da Podologia Sandra Barreto" className="text-gray-300 hover:text-white transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
