            ...
            <div className="container mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 opacity-70 mb-4">Excelência em Unhas e Podologia</p>
                        <a href="https://wa.me/5511952851860" target="_blank" rel="noopener noreferrer" className="text-brand-secondary hover:text-white font-bold text-sm transition-colors">
                            (11) 95285-1860
                        </a>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-gray-300 space-y-1">
                            ...
                            <li><a href="#manicure" className="hover:text-white transition-colors font-medium text-brand-secondary">Manicure e Gel</a></li>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram da Podologia Sandra Barreto" className="text-gray-300 hover:text-brand-secondary transition-colors">
                            ...
                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook da Podologia Sandra Barreto" className="text-gray-300 hover:text-brand-secondary transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
