                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-gray-400 space-y-1.5">
                            ...
                            <li><a href="#podologia-perto-de-mim-aberto-agora" className="hover:text-white transition-colors text-brand-secondary font-medium">Aberto Agora / Plantão Dor</a></li>
                            <li><a href="#podologia-perto-de-mim-bem-avaliada" className="hover:text-white transition-colors text-amber-400 font-semibold flex items-center gap-1">Avaliação ⭐ 5.0 Google</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/sandrabarretopodologa" target="_blank" rel="noopener noreferrer" aria-label="Instagram da Podologia Sandra Barreto" className="text-gray-400 hover:text-brand-primary transition-colors">
